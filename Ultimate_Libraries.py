...
RecoilType_list=["monoER","HO","ER","NR","BETA","LEAD","NEUTRON","COMPTON"]
...
def Ionization_Yield(Er,recoiltype="ER",energyscale="eV",Quenching="EDW"):
    ...
    elif recoiltype in ["monoER","ER","COSMOGENIC","TRITIUM","COMPTON"]:
...
class Oracle:
    def __init__(self, AnalysisEmin=None,AnalysisEmax=None,AnalysisNptx=None,LimitSetterCO = None):
