...
class DMES_Parameters:
    def __init__(self,DMmass=3e7,CrossSection=1e-37):
        ...
        self._filemasses = '/sps/edelweis/DMfiles/September-dm-masses-in-eV.txt'
        self._fileprefactor = '/sps/edelweis/DMfiles/pre-factors-for-dm-masses-rho03.dat'
    ...
    def Get_filename_from_massindex(self,massindex):
        assert massindex in np.arange(1,53+1,1) # [1,2,3,...,53]
        filename = '/sps/edelweis/DMfiles//QEdark-vesc544/C.{:02d}.dat'.format(massindex) # eg. C.01.dat, C.02.dat, ... , C.53.dat
        return filename
